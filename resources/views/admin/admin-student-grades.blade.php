        ...
        <main class="main-content">
            ...
            <header class="content-header">
                <div style="display: flex; align-items: center; gap: 16px;">
                    <a href="{{ route('admin.grades') }}"
                        style="display: inline-flex; align-items: center; padding: 8px; border-radius: 50%; background-color: #f3f4f6; color: #374151; text-decoration: none; transition: background-color 0.2s;"
                        onmouseover="this.style.backgroundColor='#e5e7eb'"
                        onmouseout="this.style.backgroundColor='#f3f4f6'" title="Back to Grades">
            ...
            <div
                ...
                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 16px;">
                    <div>
                        <div style="font-size: 12px; color: #6c757d; font-weight: 500; margin-bottom: 4px;">Student ID
                        </div>
                    ...
                    <div>
                        ...
                        <div style="font-size: 16px; color: #212529; font-weight: 600;">{{ $student->first_name }}
                            {{ $student->last_name }}
                        </div>
                    </div>
                    <div>
                        <div style="font-size: 12px; color: #6c757d; font-weight: 500; margin-bottom: 4px;">Grade Level
                        </div>
                        ...
                        @forelse($enrollments as $item)
                            <tr style="border-bottom: 1px solid #e5e7eb;">
                                <td style="padding: 12px 16px; color: #212529; font-size: 14px;">
                                    {{ $item['enrollment']->subject_code }}
                                </td>
                                <td style="padding: 12px 16px; color: #212529; font-size: 14px;">
                                    {{ $item['enrollment']->subject_title }}
                                </td>
                                <td style="padding: 12px 16px; color: #212529; font-size: 14px;">
