...
<body>
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="course-table-container">
                <h2
                    style="font-size: 20px; font-weight: 600; margin-bottom: 20px; color: #111827; font-family: 'Inter', sans-serif;">
                            ...
                            <tr>
                                ...
                                <td>
                                    <button class="assign-button"
                                        onclick="assignSubjects({{ $teacher->id }}, '{{ $teacher->first_name }} {{ $teacher->last_name }}')"
                                        style="padding: 6px 12px; background-color: #cc2128; color: white; border: none; border-radius: 4px; font-size: 13px; font-weight: 500; cursor: pointer; transition: background-color 0.2s;"
                                        onmouseover="this.style.backgroundColor='#a31a1f'"
                                        onmouseout="this.style.backgroundColor='#cc2128'">Assign Subjects</button>
                                </td>
                            </tr>
                        @empty
                            <tr>
    ...
    <div id="assignSubjectsModal"
        ...
        <div
            style="background: white; border-radius: 8px; width: 90%; max-width: 600px; padding: 24px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); max-height: 80vh; overflow-y: auto;">
            <h2
            ...
            <form id="assignSubjectsForm" method="POST">
                ...
                <div style="margin-bottom: 20px;">
                    <label
                        style="display: block; font-size: 14px; font-weight: 500; margin-bottom: 8px; color: #374151;">Select
                        Subjects:</label>
                    <div
                        style="max-height: 300px; overflow-y: auto; border: 1px solid #d1d5db; border-radius: 4px; padding: 12px;">
                        @forelse($subjects as $subject)
                            <label
                                style="display: block; padding: 8px; margin-bottom: 4px; cursor: pointer; border-radius: 4px; transition: background-color 0.2s;"
                                onmouseover="this.style.backgroundColor='#f3f4f6'"
                                onmouseout="this.style.backgroundColor='transparent'">
                                <input type="checkbox" name="subject_ids[]" value="{{ $subject->id }}"
                                    class="subject-checkbox" data-teacher-id="{{ $subject->teacher_id }}"
                                    style="margin-right: 8px;">
                                <span style="font-size: 14px;">{{ $subject->code }} - {{ $subject->title }}
                                    ({{ $subject->units }} units)</span>
                        ...
                        @empty
                            <p style="color: #6c757d; font-size: 14px; text-align: center; padding: 20px;">No subjects
                                available.</p>
                        @endforelse
                    </div>
                </div>
                <div style="display: flex; justify-content: flex-end; gap: 12px;">
                    <button type="button" onclick="closeAssignSubjectsModal()"
                    ...
                    <button type="submit"
                        style="background-color: #cc2128; color: white; border: none; padding: 10px 20px; border-radius: 4px; font-size: 14px; font-weight: 500; cursor: pointer; font-family: 'Inter', sans-serif;">Assign</button>
                </div>
            </form>
        </div>
    </div>
